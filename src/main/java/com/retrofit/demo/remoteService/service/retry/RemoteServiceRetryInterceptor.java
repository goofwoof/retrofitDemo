package com.retrofit.demo.remoteService.service.retry;
...
public class RemoteServiceRetryInterceptor extends BaseRetryInterceptor {

    private final static Logger logger = LoggerFactory.getLogger(RemoteServiceRetryInterceptor.class);
